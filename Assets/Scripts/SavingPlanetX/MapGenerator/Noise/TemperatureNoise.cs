...
public class TemperatureNoise : Noise
{
    ...
    public override float GetValue(float x, float y, MapData mapData)
    {
        ...
        float tempModifier = Mathf.PerlinNoise(OffsetX + x * BaseScale * mapData.ScaleFactor, OffsetY + y * BaseScale * mapData.ScaleFactor) * TempModifyRange - TempModifyRange / 2;
